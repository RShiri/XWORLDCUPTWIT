...
def push_match_update(png_path: str, match_id: str | None = None,
    ...
    *plus* the regenerated web-dashboard outputs (data.js, players.js, the match
    ...
    with tempfile.TemporaryDirectory(prefix="xwctwit_") as tmpdir:
        ...
        # player_lab + share are regenerated by the same render hook; omitting them
        # left scrape commits incomplete (the CI identity guard flagged the gap on
        # the 2026-07-19 third-place push: "NEW file appeared: share/…").
